				...
				<div class="detail_desc">
					...
					<form class="" method="post" action="detail.php">
						...
						<div class="form_group">
							...
							<p class="label_cente	r"><label class="subtract" onclick="subtract_price();">-</label><input readonly type="text" id="amount" name="amount" value="1"><label class="add" onclick="sum_price();">+</label><p>
